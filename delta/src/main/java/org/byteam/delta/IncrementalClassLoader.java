 ...
 * <p>
 * Used to implement incremental deployment to Android phones.
 */
class IncrementalClassLoader extends ClassLoader {
    ...
    public Class<?> findClass(String className) throws ClassNotFoundException {
        try {
            ...
            Log.i(TAG, "Incremental class loader: findClass(" + className + ") : not found");
            throw e;
        }
    }
    ...
    private static class DelegateClassLoader extends BaseDexClassLoader {
        ...
        public Class<?> findClass(String name) throws ClassNotFoundException {
            try {
                ...
                Log.i(TAG, "Delegate class loader: findClass(" + name + ") = " + aClass);

                return aClass;
            } catch (ClassNotFoundException e) {
                Log.i(TAG, "Delegate class loader: findClass(" + name + ") : not found");
                throw e;
            }
        }
    }
    ...
    private static String createDexPath(List<String> dexes) {
        ...
        Log.i(TAG, "Incremental dex path is " + BootstrapApplication.join('\n', dexes));
